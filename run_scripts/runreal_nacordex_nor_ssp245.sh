...
readonly case_name="NorESM2-MM_SSP245_E01"    # Change case name to unique experiment name (see 
readonly wrf_nodes="7"                 # Current configuration is built for 7 nodes
readonly job_priority="regular"        # job priority [economy, regular, premium]
...
readonly met_file_dir="/glade/campaign/ral/risc/trude/cordex/create_met_files/WPS_NORESM_usgf2/ssp245/met_em_files" # Point to met_files
