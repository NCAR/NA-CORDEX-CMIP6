...
readonly case_name="mpi_ssp245_002"    # Change case name to unique experiment name (see 
...
readonly met_file_dir="/glade/campaign/ral/risc/trude/cordex/create_met_files/WPS_MPI_usgf/ssp245/met_em_files" # Point to met_files
readonly wrf_master_dir="/glade/campaign/ral/risc/jsallen/CMIP6-NA-CORDEX/wrf_CORDEX/wrfv4.6.1_nac_CBIOM_SSP245" # Point to wrf model
...
if [[ "$wrf_nodes" -eq 7 ]]; then
    #readonly days=(80 80 80 80 45) # Changed here
    readonly days=(74 74 74 74 69)
    ...
    readonly real_walltime="06:00:00"
...
"
    ...
    # JSA - maybe change permissions for safe delete of files
    # -----------------------------------------
