...
readonly case_name="NorESM2-MM_HIST_E01"    # Change case name to unique experiment name (see 
...
# Time
readonly real_start="1957" # Beginning year of simluation (must include spin-up years)
readonly real_end="2020"   # End year of target simulation
readonly stop_n='12'       # Number of simulation years per chunk

# For a single continuous sim, select one year (1977)
readonly wrf_start_years=( 1947 1957 1967 1977 1987 1997 2007 )
...
readonly met_file_dir="/glade/campaign/ral/risc/trude/cordex/create_met_files/WPS_NORESM_usgf2/historical/met_em_files"
