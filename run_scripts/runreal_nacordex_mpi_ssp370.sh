...
readonly met_file_dir="/glade/campaign/ral/risc/trude/cordex/create_met_files/WPS_MPI_usgf2/ssp370/met_em_files" # Point to met_files
readonly wrf_master_dir="/glade/campaign/ral/risc/jsallen/CMIP6-NA-CORDEX/wrf_CORDEX/wrfv4.6.1_nac_CBIOM_SSP370" # Point to wrf model
...
if [[ "$wrf_nodes" -eq 7 ]]; then
    ...
    readonly rest_int=( $((1440*20)) $((1440*20)) $((1440*20)) $((1440*20)) $((1440*20)) $((1440*15)) )
    readonly leap_rest_int=( $((1440*15)) $((1440*15)) $((1440*15)) $((1440*15)) $((1440*15)) $((1440*11)) )
