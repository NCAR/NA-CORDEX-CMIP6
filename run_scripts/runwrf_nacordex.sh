...
# J. Stuivenvolt-Allen
# February 7, 2025 : Added functionality 
# to run multiple simultaneous "chunks"
...
readonly case_name="ERA5_HIST_E03"   # This MUST match the case name from the runreal_nacordex.sh script!!
readonly wrf_pbs_account="WYOM0200" 

# Time
readonly stop_n='12'       # 2-years spin-up and 10 of simulation : this got confusing
readonly wrf_start_years=( 1977 1987 1997 2007 2017 )
...
===========================================================
"
        real_dir="./real_d01/${wrf_start_year}_N4"   # setting init for the summer (YYYY-06/30)
...
N_REST_REM: ${rest_n}
    "
        ...
        # ---------------------------------------------------
        wrf_dir="${wrf_out_dir}/${wrf_start_year}_N4"  # setting init for the summer (YYYY-06/30)
